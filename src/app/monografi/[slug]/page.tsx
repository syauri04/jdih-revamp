...
export default function MonografiDetail() {
  return (
    <div className="">
      <BreadcumbPage
        title="Monografi"
      ...
      <div className="bg-[linear-gradient(180deg,rgba(102,90,0,0.05)_0%,rgba(102,90,0,0)_100%)]">
        <div className="max-w-7xl mx-auto px-6 xl:px-0 py-20 ">
          <div className="grid  grid-cols-1 md:grid-cols-[60%_35%] xl:grid-cols-[70%_30%] gap-12">
            ...
            "
              >
                Analisis dan Evaluasi Hukum Dalam Rangka Peningkatan Daya Saing
                Tenaga Kerja
              </h1>
                  ...
                  <div className="flex flex-col gap-8">
                    ...
                    font-inter
                     inline-block
                        px-3 py-1
                        text-sm 
                       text-[#352D9F] bg-[#352D9F]/10 border border-[#352D9F]
                        rounded-lg
                        w-fit
                    "
                      >
