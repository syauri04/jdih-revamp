...
import type { PeraturanFilters } from "@/app/artikel/page";
...
export default function FilterArtikel({
  filters,
  setFilters,
  draftFilters,
  setDraftFilters,
  ...
  const toggle = (key: "tipe", value: string) => {
    setFilters((prev) => ({
      ...prev,
    ...
    <>
      ...
      <div className="space-y-8">
        ...
        <div className="space-y-6">
          <h3 className="font-bold text-2xl text-[#043927]">Tipe Artikel</h3>
          ...
          <div className="space-y-3">
            {[
              { label: "Buletin", value: "Buletin", count: 112 },
              ...
              >
                <div className="flex items-center gap-3">
                  <input
                    type="checkbox"
                    checked={filters.tipe.includes(item.value)}
                    onChange={() => toggle("tipe", item.value)}
                  />
