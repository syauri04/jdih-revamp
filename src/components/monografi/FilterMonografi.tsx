...
import type { PeraturanFilters } from "@/app/monografi/page";
...
export default function FilterMonografi({
  filters,
  setFilters,
  draftFilters,
  setDraftFilters,
  ...
  const toggle = (key: "penerbit", value: string) => {
    setFilters((prev) => ({
      ...prev,
    ...
    <>
      ...
      <div className="space-y-8">
        ...
        <div className="space-y-6">
          <h3 className="font-bold text-2xl text-[#043927]">Penerbit</h3>

          {/* <input
            type="text"
            placeholder="Search by keyword"
            className="w-full h-12 px-4 border border-black/10 rounded-[10px]"
          /> */}

          <div className="space-y-3">
            {[
              { label: "Biro Hukum", value: "biro-hukum", count: 112 },
              {
                label: "Percetakan Negara RI",
                value: "percetakan-negara-ri",
                count: 52,
              },
              {
                label: "BPHN",
              ...
              >
                <div className="flex items-center gap-3">
                  <input
                    type="checkbox"
                    checked={filters.penerbit.includes(item.value)}
                    onChange={() => toggle("penerbit", item.value)}
                  />
