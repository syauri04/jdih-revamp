...
import { DokumenFilters } from "@/types/dokumen";

interface Props {
  filters: DokumenFilters;
  setFilters: React.Dispatch<React.SetStateAction<DokumenFilters>>;
  draftFilters: DokumenFilters;
  setDraftFilters: React.Dispatch<React.SetStateAction<DokumenFilters>>;
}

export default function FilterSidebarPuu({
  filters,
  setFilters,
  draftFilters,
  setDraftFilters,
      ...
      <div className="space-y-8">
        ...
        <div className="space-y-6">
          <h3 className="font-bold text-2xl text-[#043927]">
            Tipe Pengelolaan Dokumen
          </h3>

          <div className="space-y-3">
            {[
              {
                label: "Peraturan Undang-Undang",
                value: "peraturan",
                count: 32,
              },
              { label: "Putusan Pengadilan", value: "putusan", count: 12 },
              { label: "Monografi Hukum", value: "monografi", count: 23 },
              { label: "Artikel Hukum", value: "artikel", count: 14 },
            ].map((item) => (
              <label
                key={item.value}
